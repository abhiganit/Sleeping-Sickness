...
betaVL = min(0.71,1-x(1));                      % Tran. prob. from Livestock to Tsetse                                     % Tsetse
...
[tp,yp] = ode23s(@HATmodel,tspan, y0, [], eta,BV,muV0,muV1,sigmaV,aH,aL, ...
...
switch(intervention)
  ...
  case 'yearly vector control'
    ...
    [tc0,yc0] = ode23s(@HATmodel,tint, ye0, [],eta,BV,muV0,muV1,sigmaV,aH,aL, ...
               betaVH,betaVL,tauV,muH,betaH,tauH,gammaH1,gammaH2,betaL,tauL,gammaL,deltaL, ...
               P1,P1PD,P1TP,P2,P2PD,P2TP,eps1, ...
               eps2,p2,deltaH,zeta1,zeta2,rho,l,m);
    t = vertcat(t,tc0);
