function[T,Y]  = runHATmodel2(x,Data)
...
for i = 1:12
    ...
    out{1}(i) = y(end,end);
    y0 = y(end,:);
    y0(10) = y0(10) + scal*Data(i,2)*P1PD*(y0(7)+y0(9));
    y0(7) = y0(7) - scal*Data(i,2)*P1PD*y0(7);
    y0(9) = y0(9) - scal*Data(i,2)*P1PD*y0(9);
    out{2}(i) = scal*Data(i,2)*P1PD*(y0(7)+y0(9));
    y0(11) =0;
    x1 = Data(i,3);
    n1 = Data(i,2)*sum(H0);
