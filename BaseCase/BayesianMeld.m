...
bnds1 = abs(repmat(Data(3:4,1)./SampSize(3:4,1),1,2)-bnds1)
bnds2 = abs(repmat(Data(3:4,2)./SampSize(3:4,2),1,2)-bnds2)
...
errorbar(t,Data(3:4,1)./SampSize(3:4,1), bnds1(:,1),bnds1(:,2),'ko','linewidth',2)
hold off;
title('Stage I ratio')
ax = gca;
ax.XTick = [1,2]
...
errorbar(t,Data(3:4,2)./SampSize(3:4,2), bnds2(:,1),bnds2(:,2),'ko','linewidth',2)
hold off;
title('HAT')
ax = gca;
ax.XTick = [1,2]
